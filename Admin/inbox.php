...
?>
	...
	<!--//outer-wp-->
					...
					<div class="tab-pane text-style" id="tab2">
						<table class="table">
                    <tbody>										<div class="col-md-8 tab-content tab-content-in">
					<?php 
					$message_id = $_SESSION['message_id'];
						...
						while($row = mysql_fetch_array($result)){
							$date = strTime("%b %d %y",strtotime($row['time_sent']));
						if($row['opened'] == 0){
							$textWeight = "msgDefualt";
						}else{
							$textWeight = "msgRead";
						}
							$ret = "SELECT message_id,username,images FROM students WHERE message_id='$message_id' LIMIT 1";
